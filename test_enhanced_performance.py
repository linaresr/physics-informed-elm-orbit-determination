...
def create_comparison_plots(t_true, r_true, v_true, original_results, enhanced_results):
    ...
    # Extract results
    r_orig, v_orig, a_orig, physics_rms_orig, measurement_rms_orig, position_rms_orig = original_results[:6]
    r_enh, v_enh, a_enh, physics_rms_enh, measurement_rms_enh, position_rms_enh = enhanced_results[:6]
